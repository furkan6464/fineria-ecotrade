...
/// Sonraki saatler icin tuketim grafigi - sebekeden (kahve) + komsudan (yesil).
class ConsumerConsumptionChart extends StatelessWidget {
  const ConsumerConsumptionChart({super.key, required this.model});
          ...
          builder: (context, constraints) {
            ...
            return Column(
              ...
              children: [
                ...
                _Legend(
                  gridLabel: model.chartLegendGridLabel,
                  neighborLabel: model.chartLegendNeighborLabel,
                ),
              ],
            );
          },
...
class _BarPair extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hGrid = (slot.gridConsumptionKwh / maxY) * chartHeight;
    final hNeighbor = (slot.neighborConsumptionKwh / maxY) * chartHeight;
    final hg = hGrid.clamp(2.0, chartHeight);
    final hn = hNeighbor.clamp(2.0, chartHeight);
    final tallest = hg > hn ? hg : hn;
          ...
          if (slot.tooltipKwh != null)
            Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ConsumerDashboardFormatters.kwh(slot.tooltipKwh!),
                  style: const TextStyle(
...
class _YAxisLabelsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final t in ticks) {
      ...
      tp.text = TextSpan(
        text: '${ConsumerDashboardFormatters.decimal1(t)} kWh',
        style: TextStyle(
          fontWeight: FontWeight.w400,
          fontSize: 11,
...
class _Legend extends StatelessWidget {
  const _Legend({required this.gridLabel, required this.neighborLabel});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        item(ProducerDashboardColors.brown, gridLabel),
        const SizedBox(width: 22),
        item(ProducerDashboardColors.darkGreen, neighborLabel),
      ],
    );
  }
}
